		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="box box-primary">
					...
					<!-- /.box-header -->
				<!-- form start -->
				<form class="form-horizontal" action="${ctx}/trmmstgate/list" method="POST">
					<div class="box-body">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="organizationId" class="col-sm-3 control-label">商户场馆号码</label>
								<div class="col-sm-6">
									<input class="form-control" id="mm_merchant_no" name="mm_merchant_no"
										placeholder="商户场馆号码" value="${mm_merchant_no }" type="text">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="roleName" class="col-sm-3 control-label">商户场馆名称</label>
								<div class="col-sm-6">
									<input class="form-control" id="mm_biz_name" name="mm_biz_name"
										placeholder="商户场馆名称" value="${mm_biz_name}" type="text">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="roleName" class="col-sm-3 control-label">商户场馆别名</label>
								<div class="col-sm-6">
									<input class="form-control" id="mm_dba_name" name="mm_dba_name"
										placeholder="商户场馆别名" value="${mm_dba_name}" type="text">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="roleName" class="col-sm-3 control-label">商户&nbsp;|&nbsp;场馆</label>
								<div class="col-sm-6">
									<select class="form-control" id="mm_phy_state" name="mm_phy_state" path="mm_phy_state">
...
<!-- 									    <th>选择</th> -->
					...
					<div class="box-footer clearfix">
						<tags:pagination url="${ctx}/trmmstgate/list"  queryString="mm_merchant_no=${mm_merchant_no }&mm_biz_name=${mm_biz_name }&mm_dba_name=${mm_dba_name }&mm_phy_state=${mm_phy_state }" page="${pageInfo}" cssClass="pull-right" />
					</div>
					<!-- /.box -->
				</div>
				<!-- /.col -->
