						...
						<div class="box-body">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input class="form-control" id="cbEmbossname"
											name="cbEmbossname" placeholder="姓名" value="${cbEmbossname }"
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="rechargeName" class="col-sm-3 control-label">场馆号</label>
									<div class="col-sm-9">
										<input class="form-control" id="tmDbaName" name="tmDbaName"
											placeholder="场馆号" value="${tmDbaName }" oninput="buttonds()"
											type="text">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label for="rechargeName" class="col-sm-3 control-label">卡号</label>
									<div class="col-sm-9">
										<input class="form-control" id="ctCardNumber"
											name="ctCardNumber" placeholder="卡号" value="${ctCardNumber }"
											oninput="buttonds()" type="text">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="hidden" id="ctUserCreatetext"
											value="${prProdctGroup }" /> <select class="form-control"
											id="prProdctGroup" name="prProdctGroup" onchange="buttonds()">
							...
							<div class="col-sm-6">
								<div class="form-group date firstCommission">
									<label for="rechargeStart" class="col-sm-3 control-label">交易起始时间
									</label>
									<div class="col-sm-7">
										<div class="input-group date firstCommission">
											<span class="input-group-addon"> <span
												class="glyphicon glyphicon-calendar"></span>
											</span> <input readonly class="form-control" id="ctDisputeDateStart"
												name="ctDisputeDateStart" value="${ctDisputeDateStart }"
												readonly="readonly" onchange="buttonds()"
												style="width: 133.5%" />
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group date firstCommission">
									<label for="rechargeEnd" class="col-sm-3 control-label">交易结束时间
									</label>
									<div class="col-sm-7">
										<div class="input-group date firstCommission">
											<span class="input-group-addon"> <span
												class="glyphicon glyphicon-calendar"></span>
											</span> <input type="text" size="18" class="form-control"
												id="ctDisputeDateEnd" name="ctDisputeDateEnd"
												value="${ctDisputeDateEnd }" readonly="readonly"
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="rechargeFlag" class="col-sm-3 control-label">数据上传时间</label>
									<div class="col-sm-9">
										<select class="form-control" id="ctDisputeDateStatus"
											name="ctDisputeDateStatus" onchange="buttonds()">
											<option value="">===请选择===</option>
											<option value="INM"
												${ctDisputeDateStatus eq 'UPM' ? 'selected' : ''}>所选交易开始时间前</option>
											<option value="UPM"
												${ctDisputeDateStatus eq 'INM' ? 'selected' : ''}>所选交易开始时间后</option>
										</select>
									</div>
								</div>
							</div>
					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-footer clearfix">
								<tags:pagination url="${ctx}/opeartion/expense"
									page="${pageInfo}"
									queryString="cbEmbossname=${cbEmbossname }&tmDbaName=${tmDbaName }&ctCardNumber=${ctCardNumber }&prProdctGroup=${prProdctGroup }&ctDisputeDateStart=${ctDisputeDateStart }&ctDisputeDateEnd=${ctDisputeDateEnd }&ctReversalFlag1=${ctReversalFlag1 }"
									cssClass="pull-right" />
							</div>
						</div>
						<!-- /.box -->
