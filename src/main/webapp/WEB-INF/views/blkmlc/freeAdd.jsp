                	...
                	<div class="box-body">
                		<div class="col-sm-6">
                			<div class="row">
								...
								<div class="form-group">
								    <label for="organizations" class="col-sm-3 control-label">持卡人号码<font color="red">*</font></label>
								    <div class="col-sm-8">
								      <input type="password" class="form-control" id="password" name="password" value=""/>
								    </div>
								</div>
								...
								<div class="form-group">
								    <label for="status" class="col-sm-3 control-label">收费标志</label>
								    <div class="col-sm-8">
