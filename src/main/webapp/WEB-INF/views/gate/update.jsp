      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          	<div class="box box-primary">
                ...
                <form  id="stafffrom"  class="form-horizontal" method="post" action="${ctx }/ywgate/update">
                	<div class="box-body">
                		<div class="col-sm-6">
                			<div class="row">
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="hwGateName" name="hwGateName"  value="${item.hwGateName}"/>
								    </div>
								</div>
                			    <div class="form-group">
								    <label for="hwGateNote" class="col-sm-3 control-label">闸机说明</label>
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="hwGateNote" name="hwGateNote"  value="${item.hwGateNote}"/>
								    </div>
								</div>
	                			<%-- <div class="form-group">
								...
								<%-- <div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="hwGateIp" name="hwGateIp" value="${item.hwGateIp}"/>
								    </div>
								</div> --%>
								<div class="form-group">
