	...
	<div class="content-wrapper">
        ...
        <section class="content">
      	<div class="box box-primary">
            ...
            <form id="cpPrdtrmAddPage" class="form-horizontal" method="post" action="${ctx }/cpprdtrm/add">
            	<div class="box-body">
                			<div class="form-group">
							    <label for="id" class="col-sm-3 control-label">机具号<font color="red">*</font></label>
							    <div class="col-sm-8">
							    	<input style="width: 400px" type="text" class="form-control" name="pt_terminal_id" onkeyup="this.value=this.value.replace(/\s/g,'')"/>
							    </div>
							</div>
							<div class="form-group">
							    <label for="level" class="col-sm-3 control-label">产品组<font color="red">*</font></label>
							    <div class="col-sm-8">
								    <input style="width: 400px" type="text" class="form-control" name="pt_prodct_group" onkeyup="this.value=this.value.replace(/\s/g,'')"/>
							    </div>
							</div>
							<div class="form-group">
							    <label for="interval" class="col-sm-3 control-label">时间间隔</label>
							    <div class="col-sm-8">
								     <input style="width: 400px" type="text" class="form-control" name="pt_time_interval" onkeyup="this.value=this.value.replace(/\s/g,'')"/>
							    </div>
							</div>
							<div class="form-group">
							    <label for="discount" class="col-sm-3 control-label">折扣</label>
							    <div class="col-sm-8">
								    <input style="width: 400px" type="text" class="form-control" name="pt_discount" onkeyup="this.value=this.value.replace(/\s/g,'')"/>
							    </div>
							</div>
				</div>
