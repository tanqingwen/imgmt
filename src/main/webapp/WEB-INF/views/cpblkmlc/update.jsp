      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          	<div class="box box-primary">
                ...
                <form id="stafffrom" class="form-horizontal" method="post" action="${ctx }/cptktype/update">
                	<div class="box-body">
                		<div class="col-sm-6">
                			<div class="row">
								<div class="form-group">
								    <label for="ttTypeId" class="col-sm-3 control-label">类型ID<font color="red">*</font></label>
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="ttTypeId" name="ttTypeId" title="不能为空" value="${item.ttTypeId}" readonly="readonly"/>
								    </div>
								</div>
								<div class="form-group">
								    <label for="ttTypeDesc" class="col-sm-3 control-label">类型描述<font color="red">*</font></label>
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="ttTypeDesc" name="ttTypeDesc" value="${item.ttTypeDesc}"/>
								    </div>
								</div>
								<div class="form-group">
								    ...
								    <div class="col-sm-7">
									    <div class="input-group date firstCommission">
											...
											<input readonly  class="form-control" type="text" id="ttStartDate" name="ttStartDate" value="${item.ttStartDate}" onchange="countttExpirePeriod()" style="width: 116.5%"/>
	                                	</div>
	                                </div>
								</div>
								<div class="form-group uploadbox">
								    ...
								    <div class="col-sm-7">
									    <div class="input-group date firstCommission">
											...
											<input readonly  class="form-control" type="text" id="ttEndDate" name="ttEndDate" value="${item.ttEndDate}" onchange="countttExpirePeriod()" style="width: 116.5%"/>
	                                	</div>
	                                </div>
								</div>
								<div class="form-group uploadbox">
								    ...
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="ttExpirePeriod" name="ttExpirePeriod" value="${item.ttExpirePeriod}" readonly="readonly"/>
								    </div>
								</div>
								<div class="form-group uploadbox">
								    ...
								    <div class="col-sm-8">
								      <select class="form-control" id="ttUserType" name="ttUserType">
					    					...
					    					<option value="1" ${item.ttUserType eq '1' ? 'selected' : ''}>全部</option>
								      </select>
								    </div>
								</div>
								<div class="form-group">
								    <label for="ttAcqListsId" class="col-sm-3 control-label">商户地址<font color="red">*</font></label>
								    <div class="col-sm-8">
								      <select class="form-control" id="ttAcqListsId" name="ttAcqListsId">
								      	<c:forEach var="items" items="${cpAcqgrps}">
								     		<option value="${items.alGroupId }" ${items.alGroupId eq item.ttAcqListsId ? 'selected' : ''}>${items.alGroupId }-${items.alDesc }</option>
								     	</c:forEach>
								      </select>
								    </div>
								</div>
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="ttListPrice" name="ttListPrice" title="不能为空" value="${item.ttListPrice}" onchange="changettListPrice()"/>
								    </div>
								</div>  
