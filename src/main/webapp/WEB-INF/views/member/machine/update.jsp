					 ...
					 <!-- /.box-header -->
							...
							<div class="col-sm-6">
								<div class="row">
									<div class="form-group">
										<label for="id" class="col-sm-3 control-label">闸机编号</label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label for="password" class="col-sm-3 control-label">闸机品牌<font color="red">*</font></label>
										<%-- <div class="col-sm-9">
									...
									<div class="form-group">
										<label for="password" class="col-sm-3 control-label">闸机版本<font color="red">*</font></label>
										<div class="col-xs-8">
									...
									<div class="form-group" id="gateIpdiv">
											<label for="gateIp1" class="col-sm-3 control-label">闸机绑IP</label>
											<div class="col-sm-8">
												 <input type="text" class="form-control" id="tmHostSerial" name="tmHostSerial" value="${item.tmHostSerial}" readonly="readonly"/>
											</div>
									</div>
									
									<!--  
									<div class="form-group" id="gateIp">
										<label for="gateIp" class="col-sm-3 control-label">闸机绑IP</label>
										<div class="col-sm-8">
											<select class="form-control" id="tmHostSerial"  name="tmHostSerial" > 
									     		<option value="" >-----请选择闸机IP------</option>
											      	...
											      	<option value="${cpGateip.gaIp}" ${cpGateip.gaIp == item.tmHostSerial ? 'selected':''}>${cpGateip.gaIp}</option>
											      	</c:forEach>
									      	</select>
										</div>
									</div>
							...
							<div class="col-sm-6">
								<div class="row">
									...
									<div class="form-group">
										...
										-->
										<div class="form-group">
											<label for="password" class="col-sm-3 control-label">闸机状态</label>
											<div class="col-sm-8">
						...
						<div class="box-footer">
							<div class="pull-right">
		                    	...
		                    	<a type="button" class="btn btn-default" href="${ctx }/trmmstgate/viewlist/${item.tmMerchantId}"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
	                		</div>
						</div>
	              	</form:form>
				</div>
