					...
					<div class="box-header with-border">
					 ...
					 <!-- /.box-header -->
							...
							<div class="col-sm-6">
								<div class="row">
									<div class="form-group">
										...
										<div class="form-group">
											<label for="password" class="col-sm-3 control-label">闸机IP</label>
											<div class="col-sm-9">
						...
						<div class="box-footer">
	                  		<a type="submit" class="btn btn-default pull-right" href="${ctx }/machine/unexamineList/${item.tmMerchantId}"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
	              		</div><!-- /.box-footer -->								
				</div>
		</div><!-- /.box -->
	<!-- /.content-wrapper -->
