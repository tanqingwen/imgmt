					 ...
					 <!-- /.box-header -->
						<div class="box-body">
							<div class="col-sm-6">
								<div class="row">
									...
									<div class="form-group">
								    	...
								    	<div class="col-sm-8">
									     	<select class="form-control" id="tmIswatch" name="tmIswatch" disabled="disabled">
									...
									<div class="form-group">
										<label for="password" class="col-sm-3 control-label">闸机品牌</label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label for="password" class="col-sm-3 control-label">闸机版本</label>
										<div class="col-sm-8">
							...
							<div class="col-sm-6">
								<div class="row">
										...
										<div class="form-group">
				    						...
				    						<div class="col-sm-8">
												<select class="form-control" id="tmMerchantId" name="tmMerchantId" disabled="disabled"></select>
				    						</div>
										</div>
							...
							<div class="box-footer">
		                  		<a type="button" class="btn btn-default pull-right" href="${ctx }/trmmstgate/viewlist/${item.tmMerchantId }"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
		              		</div>
	              		</div>
	              	</section>
				</div>
