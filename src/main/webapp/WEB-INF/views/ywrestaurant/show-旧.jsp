      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          	<div class="box box-primary">
                ...
                <form  id="stafffrom"  class="form-horizontal" method="post" action="${ctx }/ywrestaurant/show">
                	<div class="box-body">
                		<div class="col-sm-6">
                			<div class="row">
	                			...
	                			<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <input type="text" readonly="readonly" class="form-control" id="restaurantName" name="restaurantName" title="不能为空" value="${item.restaurantName}"/>
								    </div>
								</div>
                			</div>
                		</div>
