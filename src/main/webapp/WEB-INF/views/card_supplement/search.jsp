...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="box box-primary" style="height: 400px">
			...
			<form id="form" class="form-horizontal" action="${ctx}/CardSupplement/searchMember">
			<div class="box-body" style="margin-top: 100px; margin-bottom: 100px" >
		  		<div class="form-group">
				    <label class="col-sm-2 control-label">会员身份证号码<font color="red">*</font></label>
				    <div class="col-sm-3">
				    	<input type="text" class="form-control" name="cbCustomerIdno" onkeyup="this.value=this.value.replace(/\s/g,'')"/>
				    </div>
				</div>
			</div>
