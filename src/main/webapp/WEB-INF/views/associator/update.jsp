    ...
    <div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<form id="assistantForm" class="form-horizontal" method="post" action="${ctx }/associator/update">
					...
					<div class="box box-primary">
						...
						<div class="box-body">            
							<div class="col-sm-6">
								<div class="row">
									...
									<div class="form-group">
									    <label for="hwPlateNumber1" class="col-sm-3 control-label">车牌号1<font color="red">*</font></label>
									    <div class="col-sm-8">
									...
									<div class="form-group">
									    <label for="hwAffiliatedMember" class="col-sm-3 control-label">所属会员<font color="red">*</font></label>
									    <div class="col-sm-8">
									...
									<div class="form-group">
									    <label for="hwMemberGrade" class="col-sm-3 control-label">会员等级<font color="red">*</font></label>
									    <div class="col-sm-8">
											<input type="text" class="form-control" id="hwMemberGrade" name="hwMemberGrade" value="${item.hwMemberGrade}"/>
								    	</div>
									</div>
									<div class="form-group">
										<label for="hwBlockedBalances" class="col-sm-3 control-label">冻结金额余额<font color="red">*</font></label>
										<div class="col-sm-8" >
							...
							<div class="col-sm-6">
								<div class="row">
									...
									<div class="form-group">
										<label for="hwDepositBalance" class="col-sm-3 control-label">押金余额<font color="red">*</font></label>
										<div class="col-sm-8" >
											<input type="text" class="form-control" name="hwDepositBalance" id="hwDepositBalance" value="${item.hwDepositBalance}"/>
										</div>
									</div>
									<div class="form-group">
										<label for="hwFrozenDepositBalance" class="col-sm-3 control-label">冻结押金余额金额<font color="red">*</font></label>
										<div class="col-sm-8" >
									...
									<div class="form-group">
										<label for="hwLimit" class="col-sm-3 control-label">限额<font color="red">*</font></label>
										<div class="col-sm-8" >
											<input type="text" class="form-control" name="hwLimit" id="hwLimit" value="${item.hwLimit}"/>
										</div>
									</div>
									<div class="form-group">
										<label for="hwIntegral" class="col-sm-3 control-label">积分<font color="red">*</font></label>
										<div class="col-sm-8" >
											<input type="text" class="form-control" name="hwIntegral" id="hwIntegral" value="${item.hwIntegral}"/>
										</div>
									</div>
									<div class="form-group">
										<label for="hwBankNo1" class="col-sm-3 control-label">绑定第1张银行卡<font color="red">*</font></label>
										<div class="col-sm-8" >
											<input type="text" class="form-control" name="hwBankNo1" id="hwBankNo1" value="${item.hwBankNo1}"/>
										</div>
									</div>
									<div class="form-group">
										<label for="hwBankAddress1" class="col-sm-3 control-label">银行卡1开户行<font color="red">*</font></label>
										<div class="col-sm-8" >
											<input type="text" class="form-control" name="hwBankAddress1" id="hwBankAddress1" value="${item.hwBankAddress1}"/>
										</div>
									</div>
									<div class="form-group">
										<label for="hwBankNo2" class="col-sm-3 control-label">绑定第2张银行卡<font color="red">*</font></label>
										<div class="col-sm-8" >
											<input type="text" class="form-control" name="hwBankNo2" id="hwBankNo2" value="${item.hwBankNo2}"/>
										</div>
									</div>
									<div class="form-group">
										<label for="hwBankAddress2" class="col-sm-3 control-label">银行卡2开户行<font color="red">*</font></label>
										<div class="col-sm-8" >
											<input type="text" class="form-control" name="hwBankAddress2" id="hwBankAddress2" value="${item.hwBankAddress2}"/>
										</div>
									</div>
									<div class="form-group">
								    	<label for="hwBalance" class="col-sm-3 control-label">余额<font color="red">*</font></label>
								    	<div class="col-sm-8">
						...
						<div class="box-footer">
				            <div class="pull-right">
				                ...
				                <a type="button" class="btn btn-default btn-flat" href="${ctx }/associator/list"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
							</div>
						</div><!-- /.box-footer -->
					</div>
				</form>
