...
<html>
	...
	<body class="hold-transition skin-blue-light sidebar-mini">
		<div class="wrapper">
			...
			<tags:main_sidebar active="convertTicketStat"/>
					...
					<div class="box box-primary">
		                ...
		                <form class="form-horizontal" id="thisform" action="" method="post">
		                  <div class="box-body">
			                ...
			                <div class="col-sm-6">
			                    <div class="form-group">
				                      <label for="ctTranCode" class="col-sm-3 control-label">状态</label>
				                      <div class="col-sm-9">
				                        <select class="form-control" id="ctTranCode" name="ctTranCode" onchange="buttonds()">
									    	<option value="TRANTKIN" ${ctTranCode eq 'TRANTKIN' ? 'selected' : ''}>转入</option>
									    	<option value="TRANTKOUT" ${ctTranCode eq 'TRANTKOUT' ? 'selected' : ''}>转出</option>
									    </select>
				                      </div>
				                </div>
			                </div>
		                  ...
		                  <div class="box-footer">
		                  	<div class="pull-right">
			                    ...
			                    <c:if test="${app:checkPermission('CPCEPTRX_CONVERTTICKETSTAT_DOWNLOAD') }">
						...
						<div class="col-md-12">
							<div class="box box-info">
								...
								<div class="box-footer clearfix">
									<tags:pagination url="${ctx}/cpceptrx/convertTicketStat" queryString="ctUserCreate=${ctUserCreate }&ctApproveTimeStart=${ctApproveTimeStart }&ctApproveTimeEnd=${ctApproveTimeEnd }&ctCardNumber=${ctCardNumber }&ctTranCode=${ctTranCode }" page="${pageInfo}" cssClass="pull-right"/>
								</div>
							</div><!-- /.box -->
						</div><!-- /.col -->
					</div><!-- /.row -->
	    ...
	    function buttonds (){
		    ...
		    $(document).ready(function(){
				...
				$("#theIdForSubmit").click(function(){
					...
					$("#thisform").attr("action", "${ctx}/cpceptrx/convertTicketStat");
					$("#downLoad").attr("disabled",false);
				});
				$("#downLoad").click(function(){
					$("#thisform").attr("action", "${ctx}/cpceptrx/convertTicketDownLoad");
				});
			});
		    $(function () {
