		                  ...
		                  <div class="box-body">
		                  	<div class="col-sm-6">
			                    <div class="form-group">
			                      ...
			                      <div class="col-sm-9">
			                        <input class="form-control" id="cl_old_card" name="cl_old_card" value="${cl_old_card }" oninput="buttonds()" placeholder="旧卡号">
			                      </div>
			                    </div>
		                    </div>
		                    <div class="col-sm-6">
			                    <div class="form-group">
			                      ...
			                      <div class="col-sm-9">
			                        <input class="form-control" id="cl_new_card" name="cl_new_card" value="${cl_new_card }" oninput="buttonds()" type="text" placeholder="新卡号">
			                      </div>
			                    </div>
		                    </div>
		                  	<div class="col-sm-6">		                  		
			                    <div class="form-group date firstCommission">
									<label for="rechargeStart" class="col-sm-3 control-label">换卡开始时间 </label>
									<div class="col-sm-7">
									    <div class="input-group date firstCommission">
											<span class="input-group-addon">
												<span class="glyphicon glyphicon-calendar"></span>
											</span>
	                                    	<input readonly="readonly" type="text" size="18" class="form-control" id="cl_timestampStart" name="cl_timestampStart" value="${cl_timestampStart }" onchange="buttonds()" style="width: 133.5%"/>
	                                    </div>
	                                </div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group date firstCommission">
									<label for="rechargeEnd" class="col-sm-3 control-label">换卡结束时间 </label>
									<div class="col-sm-7">
									    <div class="input-group date firstCommission">
											<span class="input-group-addon">
												<span class="glyphicon glyphicon-calendar"></span>
											</span>
	                                    	<input readonly="readonly" type="text" size="18" class="form-control" id="cl_timestampEnd" name="cl_timestampEnd" value="${ cl_timestampEnd}" onchange="buttonds()" style="width: 133.5%"/>
	                                    </div>
	                                </div>
								</div>
							</div>
						...
						<div class="col-md-12">
							<div class="box box-info">
								...
								<div class="box-footer clearfix">
									<tags:pagination url="${ctx}/vipcardStat/vipChangeStat" page="${pageInfo}" queryString="cl_old_card=${cl_old_card }&cl_new_card=${cl_new_card }&cl_timestampStart=${cl_timestampStart }&cl_timestampEnd=${cl_timestampEnd }&cl_auth_user_id=${cl_auth_user_id }" cssClass="pull-right"/>
								</div>
							</div><!-- /.box -->
						</div><!-- /.col -->
					</div><!-- /.row -->
	    ...
	    function buttonds (){
			...
			$(document).ready(function(){
				...
				$("#theIdForSubmit").click(function(){
					...
					$("#thisform").attr("action", "${ctx}/vipcardStat/vipChangeStat");
					$("#downLoad").attr("disabled",false);
				});
				$("#downLoad").click(function(){
					$("#thisform").attr("action", "${ctx}/vipcardStat/vipChangeStatDownLoad");
				});
			});	
			$(function () {
