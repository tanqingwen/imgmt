														...
														<div class="btn-toolbar pull-right" role="toolbar">
															<div class="btn-group">
															    <c:if test="${app:checkPermission('STAFF_UPDATE') }">
																	<a type="button" class="btn btn-default btn-xs" title="修改" href="${ctx}/integral/update?hwIntegralId=${item.hwIntegralId}"><i class="fa fa-fw fa-edit" aria-hidden="true"></i></a>
																</c:if>
																...
																<c:if test="${app:checkPermission('STAFF_ADD')}">
																	<a type="button" class="btn btn-default btn-xs" title="积分添加" href="${ctx}/integral/add?hwIntegralId=${item.hwIntegralId}"><i class="fa fa-home" aria-hidden="true"></i></a>		
																</c:if> 
