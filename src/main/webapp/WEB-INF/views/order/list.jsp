			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="box box-primary">
		                ...
		                -->
		                <form class="form-horizontal" action="${ctx}/appticket/list"  method="GET">
		                  	<div class="box-body">
		                  	<div class="col-sm-6">
			                    ...
			                    -->
			                        <input class="form-control" id="mobileNumber"  name="mobileNumber" placeholder="手机号" type="text">
			                      </div>
			                    </div>
		                    </div>
		                    <div class="col-sm-6">
			                    <div class="form-group">
			                      ...
			                      <div class="col-sm-9">
			                        ...
			                        <input class="form-control" id="hwOrderId"  name="hwOrderId"  type="text">
			                         -->
			                         <input class="form-control" id="ticketId"  name="ticketId"  type="text">
			                      </div>
			                    </div>
		                    </div>
		                  </div><!-- /.box-body -->
						...
						<div class="col-md-12">
							<div class="box box-info">
						                 ...
						                 <table class="table table-striped">
											...
											<tbody>
												...
												<tr>
				                                    ...
				                                    <td>
				                                    <c:if test="${item.ticketStatus eq 1}">未换票</c:if>
				                                    <c:if test="${item.ticketStatus eq 2}">已换票</c:if>
				                                    <c:if test="${item.ticketStatus eq 3}">已过闸</c:if>
													</td>
													<td>
														<div class="btn-toolbar pull-right" role="toolbar">
															<div class="btn-group">
																...
																<c:if test="${app:checkPermission('STAFF_SHOW') }">
																	<a type="button" class="btn btn-default btn-xs" title="删除"  href="${ctx}/yworder/delete?ticketId=${item.ticketId}" onclick="return confirm('确认删除?')" ><i class="glyphicon glyphicon-trash" aria-hidden="true"  ></i></a>
																</c:if>
																<%-- 订单明细查看弹框 --%>
																<%-- <c:if test="${app:checkPermission('STAFF_SHOW') }">
								...
								<div class="box-footer clearfix">
									<tags:pagination url="${ctx}/appticket/list" page="${pageInfo}" cssClass="pull-right"/>
								</div>
							</div><!-- /.box -->
						</div><!-- /.col -->
					</div><!-- /.row -->
