...
<body class="hold-transition skin-blue-light sidebar-mini">
						 ...
						 <div class="main">
                            ...
                            <div class="form-inline form-horizontal">
                                ...
                                <div class="col-md-12" style="margin-top: 20px;">
                                    <div class="col-md-6">
                                        <label for="ttStartDate" class="labelWidth">允许售票起始时间
                                            <span class="color-red">*</span>：
                                        </label>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label for="ttEndDate" class="labelWidth">允许售票终止时间
                                            <span class="color-red">*</span>：
                                        </label>
                                        <div class="input-group groupDis groupDis2 date ">
                                            <span class="input-group-addon">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control formConl line-input" id="ttListPrice" name="ttListPrice" title="不能为空" onchange="changettListPrice()"
                                                value="" />
                                        </div>
                                    </div>
                                </div>
	...
	$(document).ready(function () {
	    ...
	    $('#ttStartDate').click(function () {
	        ...
	        var t = d.getDate();
	        var dt =y+"-"+m+"-"+t;
	        WdatePicker({ el: this, dateFmt: 'yyyyMMddHHmmss',realDateFmt:'yyyyMMdd',minDate:dt});
	    });
	    ...
	    $('#ttEndDate').click(function () {
	        ...
	        WdatePicker({ el: this, dateFmt: 'yyyyMMddHHmmss', minDate:d,});
	    });
	    ...
	    $('#addButton').click(function () {
	        ...
	        $.ajax({
	            url: "http://localhost:2017/yanwu/service/calendar/ticket/save",
	            type: "POST",
	            dataType: "json",
	...
	function getTicketID() {
	    $.ajax({
	        url: "http://localhost:3551/rest/tktype/add",
	        type: "GET",
	        dataType: "json",
	        success: function (data) {
	            if (data.status == "OK") {
