		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">闸机新增</li>
				</ol>
			</section>

			<!-- Main content -->
			<section class="content">
			<form:form action="${ctx}/machine/add" modelAttribute="cpPosprm" method="post" id="machinefrom" name="machinefrom" class="form-horizontal">
					 ...
					 <!-- /.box-header -->
							...
							<div class="col-sm-6">
								<div class="row">
									<div class="form-group">
										<label for="tmTerminalId" class="col-sm-3 control-label">闸机编号<font color="red">*</font></label>
										<div class="col-sm-8">
											<input type="text" class="form-control" readonly="readonly" id="tmTerminalId" name="tmTerminalId" value="${tmTerminalId}"/>
											<input type="hidden" class="form-control" id="tmEdcSerial" name="tmEdcSerial" value="0"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">闸机品牌<font color="red">*</font></label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">闸机版本<font color="red">*</font></label>
										<div class="col-sm-8">
						...
						<div class="box-footer">
							<div class="pull-right">
		                    	...
		                    	<a type="button" class="btn btn-default" href="${ctx }/trmmstgate/viewlist/${merchantId }"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
	                		</div>
	              		</div><!-- /.box-footer -->
					</div>
				</form:form>
