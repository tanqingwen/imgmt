		                  ...
		                  <div class="box-body">
		                  	<div class="col-sm-6">
			                    <div class="form-group">
			                      <label for="organizationId" class="col-sm-3 control-label">票务ID</label>
			                      <div class="col-sm-9">
			                        <input class="form-control" id="id" name="id" placeholder="票务ID" type="text">
			                      </div>
			                    </div>
		                    </div>
		                    <div class="col-sm-6">
			                    <div class="form-group">
			                      <label for="roleName" class="col-sm-3 control-label">身份证号</label>
			                      <div class="col-sm-9">
			                        <input class="form-control" id="name" name="name" placeholder="身份证号" type="text">
			                      </div>
			                    </div>
		                    </div>
		                  </div><!-- /.box-body -->
					...
					<div class="row">
						<div class="col-md-12">
							<div class="box box-info">
								<div class="box-header with-border">
									<h3 class="box-title"><i class="fa fa-list"></i> 充值列表</h3>
