...
<body class="hold-transition skin-blue-light sidebar-mini">
				...
				<div class="content">
					<div class="main merchantAdd">
						<form:form id="thisForm" class="form-horizontal"
							action="${ctx}/cpmeracc/submitForMerchantEnteringAdd"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<form:input class="form-control formConl" id="mmMerchantNo"
											readonly="true" path="mmMerchantNo" value="系统自动生成" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="col-md-12 contract">
								<div class="col-md-6">
									<div class="form-group">
										<label>合约开始时间<i class="color-red">*</i>：
										</label>
										<div class="input-group ">
											<span class="input-group-addon"><i
												class="glyphicon glyphicon-calendar"></i></span>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>合约到期时间<i class="color-red">*</i>：
										</label>
										<div class="input-group ">
											<span class="input-group-addon"><i
												class="glyphicon glyphicon-calendar"></i></span>
							...
							<div class="col-md-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select id="mmRegCapital" name="mmRegCapital">
							...
							<div class="submit-group col-md-12 marginBottom">
								...
								<button type="submit" class="btn-size"
									style="width: 110px; margin: 0 25px 0 15px;" id="memberShip">添加</button>
							</div>
						</form:form>
	...
	<script language="javascript">
	    $(function() {
	        ...
	        $('#mmLicenseExpireBeginDate').change(function(){
	        	$('#thisForm').data('bootstrapValidator')  //时间提示错误后重新输入提示正确
	...
	/* 		var mmPmtMode = $("#mmPmtMode").val();
	 		$.ajax({
	 			async: false,
				type : "POST",
				url : "${ctx}/cpmeracc/search_mermst_Data1",
				dataType : "json",
				data : {
					mmPmtMode : mmPmtMode
				},
