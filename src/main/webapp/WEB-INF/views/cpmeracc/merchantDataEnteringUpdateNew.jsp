		...
		<div class="content-wrapper">
			...
			<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">商户修改</li>
					</ol>
				</section>
			<div class="row outer-wrap">
        <div class="tip-img"><p>商户修改</p></div> 
        <div class="content">
            <div class="main">
                <form:form id="thisForm" class="form-horizontal" action="${ctx}/cpmeracc/submitForMerchantEnteringUpdate" modelAttribute="cpMeracc" method="post">
                    ...
                    <h3 style="border-bottom: 2px dashed #6fba2c;" class="clearfix">园区信息</h3>
                     <div class="col-md-12">                   
                        <div class="col-md-6">
	                         <div class="form-group">
	                            <label>商户号码：</label>
	                            <form:input class="form-control formConl"  id="mmMerchantNo" readonly="true" path="mmMerchantNo" />
	                        </div>
                        </div>
                        <div class="col-md-6">
	                          <div class="form-group">
                  ...
                  <div class="col-md-12">            
                        <div class="col-md-6">
	                         <div class="form-group">
	                            ...
	                            <form:select path="mmPmtMode" id="mmPmtMode" style="width:220px;">
                        ...
                        <div class="col-md-6">
	                         <div class="form-group">
	                        	...
	                        	<form:select id="mmChainAccno" path="mmChainAccno" style="width:220px;">
                        ...
                        <div class="col-md-6">
	                        <div class="form-group">
	                            <label>收款单位<i class="color-red">*</i>：</label>
	                             <form:select path="mmServicingCentre" id="mmServicingCentre" class="form-control" style="width:220px;">
                    ...
                    <div class="col-md-12">                   
                        <div class="col-md-6">
	                         <div class="form-group">
	                            ...
	                            <form:select path="mmPmtFtyp" id="mmPmtFtyp" style="width:220px;">
                     ...
                     <div class="col-md-12">                   
                        ...
                        <div class="col-md-6">
	                         <div class="form-group">
	                          ...
	                          <%--   <form:input class="form-control formConl" path="mmBankName" id="mmBankName"/> --%>
		                          <form:select path="mmRegCapital" id="mmRegCapital" style="width:220px;">
                  ...
                  <div class="submit-group col-md-12 marginBottom">
                        <a href="${ctx}/cpmeracc/merchantDataEntering" class="form-a">&lt;返回</a>
		...
		$(document).ready(function(){
			...
			var mmPmtMode = $("#mmPmtMode").val();
	 		$.ajax({
	 			async: false,
				type : "POST",
				url : "${ctx}/cpmeracc/search_mermst_Data_by_mode",
				dataType : "json",
				data : {
					mmPmtMode : mmPmtMode
				},
