			...
			<div class="row">
				...
				<div class="content">
					<div class="main venueContent public">
						...
						<form:form id="thisForm" name="thisForm" class="form-horizontal " action="${ctx}/staff/submitForVenueEnteringUpdate" modelAttribute="cpMeracc" method="post">
							
								<div class="col-md-12 clearfix ">
									<div class="col-md-6 col-sm-6">
										<div class="form-group ">
											<label for="venueNum" class="">场馆号码：</label>
											<form:input class="form-control formConl line-input" id="mmMerchantNo" readonly="true" path="mmMerchantNo"/>
									...
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
											...
											<form:input class="form-control formConl line-input "  id="mmBizName" path="mmBizName" />
										</div>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 clearfix ">
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
											...
											<form:select class="venueGrade" style="width: 140px;" path="mmPmtMode" id="mmPmtMode" disabled="disabled">
												<form:option value="0">请选择级别...</form:option>
			 								<%-- 	<form:option value="1">一级--欢乐大世界</form:option> --%>
			 									<form:option value="1">二级--场馆</form:option>
			 									<form:option value="2">三级--子场馆</form:option>
											</form:select>
											<form:select style="width: 140px;margin-right:20px;"  class="venueGrade" id="mmChainAccno" path="mmChainAccno"></form:select>
									...
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
											...
											<form:input class="form-control formConl line-input" id="mmStmtName" path="mmStmtName"  />
										</div>
									</div>
								...
								<div class="col-lg-12 col-md-12 clearfix ">
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
											...
											<form:input class="form-control formConl line-input" path="mmContactName" />
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
											<label for="venueNameE">英文名称：</label>
											<form:input class="form-control formConl line-input" path="mmSmellName"  />
										</div>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 clearfix ">
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
											...
											<form:input class="form-control formConl line-input" id="mmPhyLine1" path="mmPhyLine1" />
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
											<label for="venueTel">场馆电话：</label>
											<form:input class="form-control formConl line-input" path="mmPhyTelno" />
										</div>
									</div>
								</div>
							...
							<div class="col-md-12  marginBottom">
								<a href="JavaScript:history.Go(-1)" id="cancleSubmit1" class="form-a">&lt;返回</a>
								<button  type="submit" id="theIdForSubmit" class="btn venueBtn btn-size fr">更新</button>
							</div>
					</form:form>
					</div>
      ...
      <tags:control_sidebar/>
		...
		function validatorFields(){
			...
			$(document).ready(function(){
				...
				$("#cancleSubmit1").click(function(){
					location.href="${ctx}/staff/venueDataEntering";
				});		
