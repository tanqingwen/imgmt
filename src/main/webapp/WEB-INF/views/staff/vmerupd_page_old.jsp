...
<body class="hold-transition skin-blue-light sidebar-mini">
	...
	<div class="wrapper">
        ...
        <div class="content">
            <div class="main">
                <form name="form1" id="form1" class="form-horizontal" action="${ctx}/staff/searchVmermstResultList" method = "post">
                    ...
                    <div class="submit-group">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn-size" style="width:110px; margin-left: 40px;" id="venueAuth">待授权</button>
                        </div>
                    </div>
                </form>
            </div>
