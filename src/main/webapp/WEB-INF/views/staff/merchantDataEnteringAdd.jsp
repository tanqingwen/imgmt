                ...
                <form:form id="thisForm" class="form-horizontal" action="${ctx}/staff/submitForMerchantEnteringAdd" modelAttribute="cpMeracc" method="post">
                		...
                		<div class="col-sm-6">
                			<div class="row">
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input maxlength="60" style="width: 353px"  class="form-control" path="mmContactName"/>
								    </div>
								</div>
	                			...
	                			<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input  maxlength="40"  id="mmPhyLine1" class="form-control" path="mmPhyLine1"/></th>
								    </div>
								</div>
								    ...
								    <label class="col-sm-4 control-label">合约开始时间<font color="red">*</font></label>
									  <div class="col-sm-7">
									    <div class="input-group date ">
									       ...
									       <form:input id="mmAgreementStartDate" readonly="true" class="form-control" path="mmAgreementStartDate"  style="width: 140px"/></th>
									    </div>
								    </div>
								</div>								
								<div class="form-group date">
								    <label class="col-sm-4 control-label">合约到期时间<font color="red">*</font></label>
									  <div class="col-sm-7">
									    <div class="input-group date">
									       ...
									       <form:input id="mmAgreementEndDate" readonly="true" class="form-control" path="mmAgreementEndDate" style="width: 140px"/></th>
									    </div>
								    </div>
								</div>
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input  maxlength="18" style="width: 353px"  class="form-control" path="mmBussinessLicense"/></th>
								    </div>
								</div>
								    ...
								    <label class="col-sm-4 control-label">营业执照有效期起始时间<font color="red">*</font></label>
									  <div class="col-sm-7">
									    <div class="input-group date firstCommission">
									       ...
									       <form:input readonly="true" class="form-control" path="mmLicenseExpireBeginDate"  style="width: 140px"/></th>
									    </div>
								    </div>
								</div>
								    ...
								    <label class="col-sm-4 control-label">营业执照有效期终止时间<font color="red">*</font></label>
									  <div class="col-sm-7">
									    <div class="input-group date firstCommission">
									       ...
									       <form:input readonly="true" class="form-control" path="mmLicenseExpireEndDate" style="width: 140px"/></th>
									    </div>
								    </div>
								</div>
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input maxlength="40" style="width: 353px"  class="form-control" path="mmPrincipal"/></th>
								    </div>
								</div>
							   ...
							   <div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input maxlength="25" style="width: 353px"  class="form-control" path="mmPrincipalIdNo" id="mmPrincipalIdNo"/></th>
								    </div>
								</div>
                			</div>
                		</div>
                		<div class="col-sm-6">
                			<div class="row">
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input maxlength="25" style="width: 353px"  class="form-control" path="mmPhyTelno"/>
								    </div>
								</div>
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input maxlength="60" style="width: 353px"  class="form-control" path="mmEmailAddress" id="mmEmailAddress" />
								    </div>
								</div>
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input maxlength="60" style="width: 353px" class="form-control" path="mmPmtName"/></th>
								    </div>
								</div>
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								      <form:input maxlength="60" style="width: 353px" class="form-control" path="mmBankName"/></th>
								    </div>
								</div>
								<div class="form-group">
								    <label class="col-sm-4 control-label">法人户籍地址<font color="red">*</font></label>
								    <div class="col-sm-8">
								      <form:input maxlength="60" style="width: 353px"  class="form-control" path="mmPrincipalAddress"/></th>
								    </div>
								</div>
					...
					<div class="box-footer">
						<div class="pull-right">
	                    	...
	                    	<a type="button" class="btn btn-default" href="${ctx}/staff/merchantDataEntering"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
                		</div>
					</div>
