...
<html>
	...
	<body class="hold-transition skin-blue-light sidebar-mini">
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="${ctx }/staff/searchVmermstWaitAuth">场馆维护</a></li>
			...
			<form:form class="form-horizontal" id="theFormId2"  name="theFormId2"  modelAttribute="cpMerupd" method="post">
                	<div class="box-body">
                		<div class="col-sm-6">
                			<div class="row">
	                			<div class="form-group">
								    ...
								    <div class="col-sm-8">
									  ...
									  <input type="hidden" id="mmMerchantNo1" name="mmMerchantNo1" value="${merchantNo}">
	                			...
	                			<div class="form-group">
								    <label class="col-sm-4 control-label">场馆等级</label>
								    <div class="col-sm-3">
								    ...
								    <form:select style="width: 160px;"  class="form-control" id="mmChainAccno" readonly="true" path="mmChainAccno"></form:select>
								</div>
...
<!--     第二列		 -->
								...
								<!--  
								<div class="form-group">
								    <label for="mmChainAccno" class="col-sm-4 control-label">上级场馆</label>
								    <div class="col-sm-8">
								    	<form:select style="width: 353px"  class="form-control" id="mmChainAccno" readonly="true" path="mmChainAccno"></form:select>
								    </div>
								</div>
								-->
					...
					<div class="box-footer">				
						<a  class="btn  btn-default  pull-right" id="cancelBack"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
					</div>
      ...
      <tags:control_sidebar/>
		...
		$("#cancelBack").click(function(){
			...
			location.href="${ctx}/staff/searchVmermstWaitAuth";
		});
