...
<body class="hold-transition skin-blue-light sidebar-mini">
	...
	<div class="wrapper">
        ...
        <div class="content">
            <div class="main">
                <form:form id="thisForm" class="form-horizontal" action="${ctx}/staff/submitForMerchantEnteringUpdate" modelAttribute="cpMeracc" method="post">
                  ...
                  <div class="col-md-12">            
                        ...
                        <div class="col-md-6">
	                         <div class="form-group">
	                        	...
	                        	<form:select id="mmChainAccno" path="mmChainAccno" style="width:220px;"></form:select>
	                        </div>
                        </div>
                    </div>
