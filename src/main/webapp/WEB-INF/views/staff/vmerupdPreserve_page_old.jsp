							...
							<div class="box box-info">
				                ...
				                <div class="box-body">
					                <div class="table-responsive">
												...
												<tr>
													...
													<td>
														<div class="btn-toolbar pull-right" role="toolbar">
															<div class="btn-group">
															    <c:if test="${app:checkPermission('VMERUPD_VIEW') }">
																	<a type="button" class="btn btn-default btn-xs" title="查看" href="${ctx}/staff/vmerupdPreserve_search/${item.mmMerchantNo}"><i class="fa fa-fw fa-eye" aria-hidden="true"></i></a>
																</c:if>
															    <c:if test="${app:checkPermission('VMERUPD_AUTHOH') }">
										...
										<a type="button" class="btn btn-default btn-xs" title="返回" href="${ctx}/staff/vmerupdPreserve"><i class="glyphicon glyphicon-chevron-left"></i> 返回</a>
									</div>
				                </div><!-- /.box-body -->
					
								<div class="box-footer clearfix">
									<tags:pagination url="${ctx}/staff/searchVmermstWaitAuth" page="${pageInfo}" cssClass="pull-right"/>
								</div>
			...
			$.ajax({
				...
				success : function(data) {
					if(data == currentStaffId){
						...
						if(confirm("确定授权？")){
							location.href = "${ctx}/staff/venueDataMerupdEntering_authorize/"+merchantNo;
						}
					}
				}
			});
