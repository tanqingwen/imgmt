			...
			<div class="row">
				...
				<div class="content">
					<div class="main">
						...
						<!-- form start -->
						<form id="defaultForm" name="defaultForm" class="form-horizontal" action="${ctx}/staff/searchResultList" method = "post">
														...
														<div class="btn-toolbar"  role="toolbar">
															<div class="btn-group">
																<c:if test="${app:checkPermission('MERMST_VIEW') }">
																	<span class="check"><a href="${ctx}/staff/merchantPreserve_view/${item.mmMerchantNo}" class="">商户详情</a></span>
<%-- 																	<a type="button" class="" title="查看" href="${ctx}/staff/merchantPreserve_view/${item.mmMerchantNo}"><i class="" ></i></a>
 --%>															</c:if>
																<c:if test="${app:checkPermission('VENUEMERMST_GLIST') }">
																	...
																	<span class=""><a href="${ctx}/staff/trmmstPreserve_view/${item.mmMerchantNo}">终端列表</a></span></td>
																</c:if>
															</div>
														</div>
													</td>
