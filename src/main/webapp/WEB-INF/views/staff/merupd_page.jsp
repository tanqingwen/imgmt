...
<body class="hold-transition skin-blue-light sidebar-mini">
	...
	<div class="wrapper">
        ...
        <div class="content">
            <div class="main">
                <form name="form1" id="form1" class="form-horizontal" action="${ctx}/staff/searchMermstResultList" method = "post">
	...
	$("#venueAuth").click(function(){
		...
		location.href="${ctx}/staff/searchMermstWaitAuth?mmMerchantNo="+mmMerchantNo+"&mmBizName="+mmBizName;
	});
