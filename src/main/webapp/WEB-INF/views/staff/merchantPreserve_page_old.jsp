					...
					<div class="box box-primary">
		                ...
		                <form class="form-horizontal" action="${ctx}/staff/searchResultList" method = "post">
		                  <div class="box-body">
		                    ...
		                    <div class="col-sm-6">
			                    <div class="form-group">
			                      <label for="merchantFName" class="col-sm-3 control-label">商户简称</label>
			                      <div class="col-sm-9">
			                        <input class="form-control" id="mmStmtName" name="mmStmtName" value="${mmStmtName }" type="text">
			                      </div>
			                    </div>
		                    </div>
		                    ...
		                    <div class="col-sm-6">
							    ...
							    <div class="col-sm-9">
							    	<select class="form-control" id="mmChainAccno" name="mmChainAccno"></select>
							    </div>
								</div>
							</div>	
												...
												<tr>
													...
													<td>
														<div class="btn-toolbar pull-right" role="toolbar">
															<div class="btn-group">
																<!--  	
															    <c:if test="${app:checkPermission('PRESSMV_UPDATE') }">
																...
																<!-- 
																	<c:if test="${app:checkPermission('PRESSTRMMST_VIEW') }">
