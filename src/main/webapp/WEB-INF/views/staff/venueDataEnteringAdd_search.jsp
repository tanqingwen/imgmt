...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="${assets }/layer/skin/css/layer.css" />
		<title>场馆详情</title>
					...
					<div class="main venueContent">
						...
						<form:form class="form-horizontal" id="theFormId2"  name="theFormId2"  modelAttribute="cpMeracc" method="post">
								...
								<div class="col-lg-12 col-md-12 clearfix ">
									<div class="col-lg-6 col-md-6">
										<div class="form-group">
											...
											<form:select style="width: 144px;"  class="venueGrade" id="mmChainAccno" disabled="true" path="mmChainAccno"></form:select>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="form-group ">
							...
							<div class="col-md-12  marginBottom">
								<a href="${ctx}/staff/venueDataEntering" class="form-a">&lt;返回</a>
							</div>
					</form:form>
					</div>
