      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          	<div class="box box-primary">
                ...
                <form class="form-horizontal" id="stafffrom" method="post" action="${ctx }/staff/update">
                	<div class="box-body">
                		<div class="col-sm-6">
                			<div class="row">
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								    	 <%-- <input type="text" class="form-control" id="organizations" name="organizations" value="${item.organizations}"/> --%> 
						                    ...
						                    <div class="col-lg-6">
												<div class="input-group">
													<span class="input-group-addon">
														<input type="checkbox" name="roles" value="${role.id }" ${app:stringContains(item.roles, role.id) ? 'checked':'' }/>
													</span>
