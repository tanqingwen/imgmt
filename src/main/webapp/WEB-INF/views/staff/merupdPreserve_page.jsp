...
<body class="hold-transition skin-blue-light sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">商户维护授权</li>
				</ol>
			</section>

			<!-- Main content -->
			<div class="container-fluid venue-entry Authorization">
					...
					<div class="content">
						<div class="main">
							<form id="defaultForm" name="defaultForm" class="form-horizontal">
								<h3 style="border-bottom: 2px dashed #45a0e0;">商品维护授权</h3>
							...
							<div class="col-lg-12 col-md-12 clearfix tableContent" style="display: block;">
														...
														<div class="" role="toolbar">
															 <div class="btn-group"> 
															    <c:if test="${app:checkPermission('MERUPD_VIEW') }">
																	<a type="button" class="" title="查看" href="${ctx}/staff/merupdPreserve_search/${item.mmMerchantNo}"><span class=""  aria-hidden="true">查看</span></a>
																</c:if>
															    <c:if test="${app:checkPermission('MERUPD_AUTHOH') }">
																	<a type="button" class="" title="授权" onclick="theIdForImpower('${item.mmMerchantNo}')" ><span class=""  aria-hidden="true">授权</span></a>
																</c:if>
								...
								<div class="box-footer clearfix">
									<a id="fanhui" href="JavaScript:history.Go(-1)" class="form-a" >&lt;返回</a>
	...
	<script type="text/javascript">
		...
		$("#fanhui").click(function(){
			location.href="${ctx}/staff/merupdPreserve";
		});
	</script>
