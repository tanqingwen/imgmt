		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">商户维护列表</li>
				</ol>
			</section>

			<!-- Main content -->
			<div class="row outer-wrap">
				<div class="tip-img" id="tip-img">
					<p>商户维护列表</p>
				</div>
				<div class="content">
					<div class="main">
							...
							<div class="col-lg-12 col-md-12 clearfix tableContent"
								...
								<div class="checkList">
										...
										<tbody>
											<c:forEach var="item" items="${pageInfo.list}">
												<tr>
													...
													<td><span class="edit"> <c:if
																test="${app:checkPermission('MERUPD_MAINTAIN_UPDARE') }">
																<a style="text-decoration: none;"
																	href="${ctx}/cpmermst/mermstPreserve_update/${item.mmMerchantNo}">更新</a>
															</c:if>
													</span></td>
												</tr>
											</c:forEach>
									...
									<div class="box-footer clearfix">
										<a href="${ctx}/cpmermst/merupdPreserve" class="form-a">&lt;返回</a>
										<tags:pagination url="${ctx}/cpmermst/searchVmermstResultList"
