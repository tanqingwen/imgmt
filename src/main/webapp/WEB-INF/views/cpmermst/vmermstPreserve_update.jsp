		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${ctx }/cpmermst/searchVmermstResultList">场馆维护</a></li>
					...
					<div class="content">
						<div class="main venueContent">
							...
							<form:form id="defaultForm" modelAttribute="cpMermst"
								...
								action="${ctx}/cpmermst/submitForVenuePreserver_update">
								...
								<div class="col-md-12  marginBottom">
									<a href="${ctx }/cpmermst/searchVmermstResultList" class="form-a" onclick="cancleSubmit()">&lt;返回</a>
									<button class="btn btn-size fr" id="theIdForSubmit" type="submit" onclick="validatorFields()">更新</button>
								</div>
							</form:form>
						</div>
					</div>
