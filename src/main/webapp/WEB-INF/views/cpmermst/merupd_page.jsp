...
<body class="hold-transition skin-blue-light sidebar-mini">
	...
	<div class="wrapper">
        ...
        <div class="content">
            <div class="main">
                <form name="form1" id="form1" class="form-horizontal" action="${ctx}/cpmermst/searchMermstResultList" method = "post">
                    <h3 style="border-bottom: 2px dashed #45a0e0;">查询表单</h3>
                    <div class="form-group">
                        <div class="col-lg-6">
                            <label>商户号码</label>
                            <input class="form-control formConl" type="text" id="mmMerchantNo" name="mmMerchantNo" value="${mmMerchantNo }"/>
                        </div>
                        <div class="col-lg-6">
                            <label>商户名称</label>
                            <input class="form-control formConl" type="text" id="mmBizName" name="mmBizName" value="${mmBizName }" />
                        </div>
                    </div>
                    <div class="submit-group">
                        ...
                        <div class="btn-group">
                            ...
                            <c:if test="${app:checkPermission('MERUPD_MAINTAIN_SHOW') }">
                            	<button type="button" id="venueAuth" class="btn-size" style="width:110px; margin-left: 40px;">待授权</button>
                        	</c:if>
                        </div>
                    </div>
                </form>
	...
	$("#venueAuth").click(function(){
		...
		location.href="${ctx}/cpmermst/searchMermstWaitAuth?mmMerchantNo="+mmMerchantNo+"&mmBizName="+mmBizName;
	});
