			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="${ctx }/cpmermst/searchMermstWaitAuth">商户维护</a></li>
						<li class="active">商户维护详情</li>
					</ol>
				</section>
				<!-- Main content -->
...
<!--         <section class="content"> -->
<!--           	<div class="box box-primary"> -->
                <form:form class="form-horizontal" id="theFormId"  name="theFormId"  modelAttribute="cpMerupd" method="post">
                	<div class="box-body">
                		<div class="col-sm-6">
                			<div class="row">
...
<!--     第二列		 -->
								...
								<div class="form-group">
								    <label class="col-sm-4 control-label">商户收银银行</label>
								    <div class="col-sm-8">
					...
					<div class="box-footer">
						<a  class="btn  btn-default  pull-right" href="${ctx}/cpmermst/searchMermstWaitAuth"><i class="glyphicon glyphicon-chevron-left" ></i> 返回</a>
					</div>
			</form:form>
