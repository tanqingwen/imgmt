								...
								<div class="col-lg-12">
									<div class="col-lg-6 banbiehao">
										<dl>
											...
											<dd>
												结班员工工号: <span>${shift.cpShiftUserno}</span>
											</dd>
											<dd>
												结班员工: <span>${shift.cpShiftUser }</span>
											</dd>
										</dl>
									</div>
									<div class="col-lg-6 banbiehao">
										<dl>
											<dd>
												结班时间: <span id="jbTime">${shift.cpShiftDate }</span>
											</dd>
											<dd>
									...
									<div class="col-lg-6 banbiehao">
										...
										<table border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												...
												<td style="width: 10%;">:</td>
												<td style="width: 30%;"></td>
												<td style="width: 20%; text-align: right;">${shift.cpShiftJbxj }</td>
											</tr>
											<%-- <tr>
