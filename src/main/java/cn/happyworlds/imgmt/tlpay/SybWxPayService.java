...
public class SybWxPayService {
	public Map<String,String> pay(long trxamt,String reqsn,String paytype,String body,String remark,String openid,String authcode,String notify_url,String limit_pay) throws Exception{
