...
public class TranxServiceImpl {
	...
	public void batchDaiShou(String url,boolean isTLTFront) throws Exception {
    	...
    	trans_detail.setACCOUNT_NAME("谭清文") ;
 		trans_detail.setACCOUNT_PROP("0") ;
		trans_detail.setACCOUNT_NO("6217001210074546654") ;
		trans_detail.setBANK_CODE("105") ;
...
//		trans_detail2.setACCOUNT_NAME("柏明") ;
//		trans_detail.setACCOUNT_PROP("0") ;
//		trans_detail2.setACCOUNT_NO("6227004270990160838") ;
//		trans_detail2.setBANK_CODE("105") ;
//		trans_detail2.setAMOUNT("10") ;
...
//		System.out.println(new String(resp.getBytes(),"GBK")) ;
	...
	public void downBills(String url, boolean isTLTFront) throws Exception {
		...
		xml=XmlTools.buildXml(aipgReq,true);//.replaceAll("</INFO>", "</INFO><BODY>").replaceAll("</AIPG>", "</BODY></AIPG>");
		isFront(xml,isTLTFront,url);
	}
	/**
	 * 签约通知
...
//		String SETTDAY ="20170707";
//		String REQTIME ="20170707134912";//df.format(new Date());
//		String CONTFEE ="";
//		String SIGN ="";
...
//	}
	...
	public void singleDaiFushi(String url,boolean isTLTFront) throws Exception {
		...
		trans.setACCOUNT_NAME("谭清文");
		trans.setACCOUNT_NO("6217001210074546654");
