...
public class FileUploadUtils implements FileUploadUtilsInter {
    ...
    public FileUploadUtils(String[] fileType, long fileSize,  
    ...
    public void uploadFiles(HttpServletRequest request, String urlString)  
        ...
        if (cachePathString != null) {  
            ...
            factory.setSizeThreshold(Integer.valueOf(String.valueOf(cacheSize)));  
        }  
